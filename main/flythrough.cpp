...
int main(void)
{
	...
	*/
	...
	png[0].Decode("assets/asteroids.png");
	png[1].Decode("assets/CentipedeMenu.png");
	png[2].Decode("assets/FroggerGame.png");
	png[3].Decode("assets/GalagaSprite/GalagaScreen.png");
	png[4].Decode("assets/Menu.png");
	png[5].Decode("assets/TetrisScreen.png");
	png[6].Decode("assets/FinalTron.png");
	png[7].Decode("assets/Asteroids_header.png");
	png[8].Decode("assets/CentipedeBanner.png");
	png[9].Decode("assets/froggerBanner.png");
	png[10].Decode("assets/galagabanner.png");
	png[11].Decode("assets/BannerPacman.png");
	png[12].Decode("assets/TetrisSign.png");
	png[13].Decode("assets/TronBanner.png");
	png[14].Decode("assets/mainmenu.png");
	...
	others[0].Decode("assets/floor.png");
	others[1].Decode("assets/HighScores.png");
	for(int i = 0; i < 2; i++){
